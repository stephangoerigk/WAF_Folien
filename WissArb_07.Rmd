...
Hierzu berichtet man für die gängigen sozialstatistischen bzw. soziodemographischen Merkmale ...
  ...
  * Alter
  * Familienstand
  * Bildungsgrad, Tätigkeit* Einkommen
  * Wohnort 
  * ...etc.
...
* Neben Stichprobenbeschreibung, Messinstrumenten und Versuchsdurchführung wird im Methodenteil auch auf die Daten- analyse eingegangen
...
* Generell wenden wir uns bei der Abfassung eines Forschungs- berichtes an einen methodisch und fachlich vorinformierten Leserkreis. 
