...
### Übungsaufgaben
##### 26.01.2023 | Dr. phil. Stephan Goerigk
...
g_k_Ruhe = data.frame(Errors = round(rnorm(5, 2, 2)))
g_j_Ruhe = data.frame(Errors = round(rnorm(5, 2, 2)))
g_e_Ruhe = data.frame(Errors = round(rnorm(5, 2, 2)))
